      ...
      <div className="px-4 py-2 flex flex-col items-center">
        <div className="rounded-lg shadow-lg p-12 flex flex-col items-center bg-opacity-70 backdrop-filter backdrop-blur-xl border border-gray-500">
          ...
          <p className="text-white text-xl text-center mt-4">
            With real-time data powered by NASA's APIs, we present a collection
            of breathtaking images and insights from Mars and Earth. Our
            application's responsive design ensures seamless access across all
            devices, while Firebase integration provides a robust backend
            infrastructure. Join us in exploring the unknown, as we unravel the
            mysteries of space through stunning visuals and captivating
            discoveries.
          </p>
        </div>
      </div>
